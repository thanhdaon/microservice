...
async function crawHtmlAutoScroll({cookieFilePath, url, crawedPath}) {
...
async function loadFBCookie(page, pathToCookieFile) {
  const urls = [
    ...
    'https://m.facebook.com', 'https://mbasic.facebook.com',
    'https://developers.facebook.com', 'https://upload.facebook.com',
    'https://mobile.facebook.com', 'https://business.facebook.com'
  ];
...
module.exports = crawHtmlAutoScroll;
